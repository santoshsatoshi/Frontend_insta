...
async def webhook():
    ...
    try:
        ...
        if update.effective_chat:
            try:
                await telegram_app.bot.send_message(chat_id=update.effective_chat.id, text="An error occurred. Please try again later.")
...
def keep_alive():
    """Prevent bot from sleeping by pinging itself every 5 minutes."""
    while True:
        try:
...
if __name__ == "__main__":
    ...
    # Keep bot alive in a separate thread
